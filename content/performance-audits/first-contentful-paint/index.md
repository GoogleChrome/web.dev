...
<img class="screenshot" src="./first-contentful-paint.png" alt="Lighthouse: First Contentful Paint metric">
...
<img class="screenshot" src="./opportunities.png" alt="Lighthouse: Opportunities section">
