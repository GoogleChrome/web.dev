...
description: |
  ...
  web fonts.
web_updated_on: 2019-15-03
web_published_on: 2019-15-03
...
<img class="screenshot" src="./lighthouse-audit-before-preload.png" alt="Lighthouse audit - Before Preload">
...
<img class="screenshot" src="./network-before-preload.png" alt="Network Request before preload">
...
<img class="screenshot" src="./lighthouse-audit-after-prelaod.png" alt="Lighthouse Audit - after preload">

Notice how the Pacifico-Bold.woff2 is removed from the critical request chain. It is fetched earlier in the application.

<img class="screenshot" src="./network-after-preload.png" alt="Network Request after preload">
