...
`gulpfile.js` file should now look like this:
...
## 4. Customize Imagemin's configuration
...
## 5. Customize Imagemin configuration (continued)
...
## 7. Verify results using Lighthouse
