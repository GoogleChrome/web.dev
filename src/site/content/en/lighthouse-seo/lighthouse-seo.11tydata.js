module.exports = {
  ...
  path: {
    ...
    title: "SEO audits",
    description: "How well can search engines understand your content?",
    ...
    topics: [
      ...
      },
      {
        ...
        pathItems: ["http-status-code", "is-crawable", "robots-txt", "plugins"],
      },
      {
        title: "Make your page mobile-friendly",
        pathItems: ["viewport", "font-size", "tap-targets"],
      },
      {
        title: "Things to check manually",
        pathItems: ["structured-data"],
      },
    ],
  },
};
