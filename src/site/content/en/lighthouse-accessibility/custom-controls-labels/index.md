---
layout: post
title: Manually check all custom controls are keyboard focusable
description: |
...
Try pressing the <kbd>TAB<tbd> key to navigate through your site.
...
press the `TAB` key or call the element's `focus()` method.
