...
<figure class="w-figure">
  <img class="w-screenshot w-screenshot--filled" src="frame-title.png" alt="Lighthouse: Frame or IFrame doesn't have a title elemement">
...
Learn more in
[Write descriptive titles, descriptions, and link text for every page](/discoverable/write-descriptive-text).
