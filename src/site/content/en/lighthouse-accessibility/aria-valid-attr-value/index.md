...
<figure>
  {% Img src="image/tcFciHGuF3MxnTr1y5ue01OGLBn2/d3U3jGziH67BYcWPa1T4.png", alt="Lighthouse audit showing aria-checked without the value 'true'", width="800", height="185" %}
</figure>
...
- <a href="https://github.com/GoogleChrome/lighthouse/blob/master/core/audits/accessibility/aria-valid-attr-value.js" rel="noopener">Source code for **`[aria-*]` attributes do not have valid values** audit</a>
