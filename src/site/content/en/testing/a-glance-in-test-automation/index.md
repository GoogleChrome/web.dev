---
layout: post
title: Quick overview of types of test automation
date: 2023-04-30
description: |
...
{% Img src="image/placeholder.jpg", alt="A cupboard with two drawers you cannot open at the same time", width="380", height="240" %}
...
{% Img src="image/placeholder.jpg", alt="The same cupboard but with two drawers you can open at the same time", width="380", height="240" %}
...
{% Img src="image/placeholder.jpg", alt="A simplified depiction of unit testing showing in- and output", width="380", height="240" %}
...
{% Img src="image/placeholder.jpg", alt="A simplified depiction of integration testing showing how two unit working together", width="380", height="240" %}
...
{% Img src="image/placeholder.jpg", alt="A simplified depiction of end-to-end testing showing a computer as a robot, looking at a workflow", width="380", height="240" %}
...
{% Img src="image/placeholder.jpg", alt="A lot of shapes like pyramid, diamonds, ice cone, honeycombs and a trophy; representing test strategies", width="380", height="240" %}
