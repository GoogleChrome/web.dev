module.exports = {
  assessment: {
    ...
    questions: [
      {
        stimulus: `This HTML renders a modal dialog:
          \`\`\`html
      ...
      },
      {
        ...
        options: [
          {
            rationale: `Only the \`<a>\` elements are included in the tab order.
      ...
      {
        stimulus: `This HTML renders a popup menu followed by a search input:
        ...
        options: [
          {
            rationale: `The **Search** text input comes first in the tab order.
      ...
      {
        stimulus: `This HTML renders a custom radio group, which should have a
          ...
          \`\`\``,
        type: "think-and-check",
        stem: `When a \`role="radio"\` element is focused, what should happen when a user presses the \`Right\` arrow key?`,
        options: [
          {
            rationale: `- Change the \`tabindex\` values for all radio elements in the group to -1.
