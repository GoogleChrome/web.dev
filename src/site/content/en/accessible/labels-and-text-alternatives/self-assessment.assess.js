...
\`\`\``,
        ...
        options: [
          {
            rationale: `**Yes**. Give an image an accessible name by adding an \`alt\`
attribute.`,
          },
        ],
      },
...
\`\`\``,
        ...
        options: [
          {
            rationale: `**No**. Give an \`<object>\` element a name by providing text content.
(An \`alt\` attribute on an object will not be read by assistive technologies.)`,
          },
        ],
      },
      {
        stimulus: `This sample renders an icon button:
...
\`\`\``,
        ...
        options: [
          {
            rationale: `**No**. Give a button an accessible name by providing text content,
an \`aria-label\` attribute, or an \`aria-labelledby\` attribute.`,
          },
        ],
      },
      {
        stimulus: `This sample renders an icon button with a tooltip that appears on hover and focus:
...
\`\`\``,
        ...
        options: [
          {
            rationale: `**Yes**. Even if the button's tooltip is visually hidden using CSS,
...
\`\`\``,
        ...
        options: [
          {
            rationale: `**Yes**. The label is associated with the checkbox
...
\`\`\``,
        ...
        options: [
          {
            rationale: `**No**. The checkbox's \`value\` attribute indicates
