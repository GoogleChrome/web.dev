    ...
    questions: [
      {
        ...
        options: [
          {
            rationale: `This sample should use a **link**. The sample is **correct**.
      ...
      {
        stimulus: `When selected, this element opens a modal dialog:
        ...
        options: [
          {
            rationale: `This sample should use a **button**. The sample is **incorrect**.
      ...
      {
        stimulus: `When selected, this element opens a navigation menu:
      ...
      {
        stimulus: `This code renders a horizontal navigation menu at the top of a website:
        ...
        options: [
          {
            rationale: `This sample should use **links**. The sample is **incorrect**.
