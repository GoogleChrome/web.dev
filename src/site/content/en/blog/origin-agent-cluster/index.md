...
subhead: A new HTTP response header to limit domain-wide scripting and request dedicated resources from the browser.
authors:
  - domenic
description: >
