...
Terra, one of Brazil's largest media companies with 75 million monthly users, reduced the bounce rate by 60% and pages read per session by 170% on desktop for users that prefer dark mode by providing a custom dark theme.
