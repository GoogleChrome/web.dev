...
subhead: Modifying the DOM order with tabindex
description: |
...
Elements](https://developers.google.com/web/fundamentals/web-components/customelements) that
...
guide](https://www.w3.org/TR/wai-aria-practices/).
Section 2 contains a list of design patterns, and in that list is a
[characteristics table for radio
groups](https://www.w3.org/TR/wai-aria-practices/#radiobutton),
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/UU2j5d9g5JzYPlBi7rMo.png", alt="W3C spec excerpt for radio buttons.", width="640", height="359" %}
</figure>
...
element](https://gist.github.com/robdodson/85deb2f821f9beb2ed1ce049f6a6ed47)
over on GitHub.
...
element](https://webaim.org/standards/wcag/checklist#sc2.1.2).
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/34igvq1J0jtvgSp3Tybo.png", alt="A modal window asking the user to save their work.", width="640", height="357" %}
</figure>
...
>
> See this [MDN
> article](https://developer.mozilla.org/docs/Web/HTML/Element/dialog)
> for more information on `<dialog>`, and this
> [modal example](https://github.com/gdkraus/accessible-modal-dialog) for
