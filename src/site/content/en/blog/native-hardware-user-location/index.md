...
<div class="switcher">
    <figure>
        {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/SRthCdxTNxobbS0cZRK0.png", alt="sw navigation good", width="325", height="550" %}
        <figcaption class="success">
            <b>DO</b>: Always request access to location on a user gesture.
        </figcaption>
    </figure>
    <figure id="fig1">
        {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/HZ9AGAUsL25JXy1QyQ2J.png", alt="sw navigation bad.", width="325", height="550" %}
...
<div class="switcher">
  <figure>
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/JxupYILmv2SpCZpMuKfn.png", alt="indication", width="800", height="170" %}
    <figcaption>
      Use a range finder
     </figcaption>
  </figure>
  <figure>
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/zwN5bqjUPoEpNb7tWMdG.png", alt="nearme", width="740", height="314" %}
    <figcaption>
...
<div class="attempt-right">
  <figure id="fig1">
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/93LX67N4Q0B5YvF6JVSf.png", alt="sensors drawer", width="800", height="454" %}
  </figure>
</div>
