...
{% Img src="image/admin/q6RSuwuwLT7mcgE9Joqp.png", alt="Googlebot holding the Chrome logo", width="400", height="401", caption="Googlebot is now running a modern Chromium rendering engine." %}
...
{% Img src="image/admin/lzijYVwo1DPX3Fa2liXk.png", alt="A code box showing HTML that loads some scripts. A screenshot of a web page on mobile that shows placeholder images while loading the actual content.", width="800", height="447", caption="The rendering strategy influences the performance and robustness of your web apps." %}
...
{% Img src="image/admin/15IgtDchchBvLsVyzmG2.png", alt="The mobile-friendly test shows the rendered HTML Googlebot sees after rendering the page", width="800", height="414", caption="The mobile-friendly test shows you the rendered HTML Googlebot uses." %}

You can also find out if there are resource loading issues or JavaScript errors.

{% Img src="image/admin/22ttektRnHrbGT0zvbHK.png", alt="The Mobile-Friendly Test shows JavaScript errors and a stack trace.", width="800", height="414", className="w-screenshot", figure=true %}
...
{% Img src="image/admin/JYsPy8FXL3E86gCzekQ3.png", alt="The URL inspection tool showing a page that is indexed with information on discovery, crawling and indexing for one URL", width="800", height="655", className="w-screenshot", caption="The URL Inspection Tool in Search Console shows the status of a page in crawling, rendering, and indexing." %}
...
{% Img src="image/admin/ctch0ql8UQZiaKaWy34u.png", alt="A lighthouse SEO report with a score of 44 and warnings about mobile-friendliness as well as warnings about content best practices", width="800", height="443", className="w-screenshot", caption="Lighthouse shows general SEO recommendations for a page." %}
