...
its name, Excalidraw, and, like with every good side project, buying the domain name was one of
...
Today, Excalidraw is a full-fledged installable progressive web app with offline support, a stunning
...
{% Video src="video/8WbTDNrhLsU0El80frMBGE4eMCD3/5URMXtB5p1SlXAu6vec1.mov", autoplay=true, muted=true, playsinline=true %}
...
{% Video src="video/8WbTDNrhLsU0El80frMBGE4eMCD3/QEGZnA7ibmOqGzxyRy8K.mov", autoplay=true, muted=true, playsinline=true %}
...
back for future use. The rest is then just writing to the file, which happens through a writable
stream.

{% Video src="video/8WbTDNrhLsU0El80frMBGE4eMCD3/lLsNzJVX6Wled0IGhiB5.mov", autoplay=true, muted=true, playsinline=true %}
...
{% Video src="video/8WbTDNrhLsU0El80frMBGE4eMCD3/fZ7wTjRmJYPohZePGFgY.mov", autoplay=true, muted=true, playsinline=true %}
...
{% Video src="video/8WbTDNrhLsU0El80frMBGE4eMCD3/4nPI2zAweRre3ERDpG6t.mov", autoplay=true, muted=true, playsinline=true %}
...
The secret for making this happen is by calling getAsFileSystemHandle on the data transfer item when
the File System Access API is supported. I then pass this file handle to loadFromBlob, which you may
remember from a couple slides ago. So many things you can do with files: opening, saving,
...
Another system integration currently on Android, Chrome OS, and Windows is through the Web Share
Target API. Here I am in the Files app in my Downloads folder. I can see two files, one of them with
...
{% Video src="video/8WbTDNrhLsU0El80frMBGE4eMCD3/S3mqjw6bM7y28WxSpd0y.mov", autoplay=true, muted=true, playsinline=true %}
...
{% Video src="video/8WbTDNrhLsU0El80frMBGE4eMCD3/7kXfnwa8Swlsa3YFNReQ.mov", autoplay=true, muted=true, playsinline=true %}
...
the Idle Detection API, an early stage proposal that's been worked on in the context of Project
...
We filed feedback on why the Idle Detection API wasn't solving the use case we had. All Project Fugu
APIs are being developed in the open, so everyone can chime in and have their voice heard! Talking
