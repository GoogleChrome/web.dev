...
<figure>
  {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/SMMXsJT0g2ivhkxfB9Rc.png", alt="Basic MSE data flow", width="305", height="250" %}
...
<figure>
  {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/ue5eqd9gCmKRnBzs36hn.png", alt="A source attribute as a blob", width="433", height="251" %}
...
type and _two_ codecs. This is a mime string for a video file, but it uses
...
_while media are playing_. You may have heard the terms DASH or HLS, which are
