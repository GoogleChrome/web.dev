...
This question was intentionally placed near the end of the survey, after
...
All of these things can then be made harder due to missing browser features,
...
spacebar presses, and gamepads and it can be difficult to include these if
custom scroll work is being done. Almost half of the respondents report it's
...
Some of the survey questions asked about usage of certain APIs with a possible
...
<figure class="w-figure">
  ...
  <figcaption class="w-figure">
    Video shows cyclical seconds scrolling, <br>
    where after 60 it's begins at 0 again
  </figcaption>
</figure>

Those numbers are quite high for a scrolling feature the web provides very
little to no support for. The feature often incurs high amounts of technical
debt because of this, with duplication or JavaScript injected to force the
effect. It's popular for product carousels and selecting seconds or minutes, to
...
Respondents felt strong about the importance of scrollable areas. Another signal
of the sentiment behind the struggles required to deliver high quality
scrollable areas.
...
it to be easy to manage. Off the shelf carousels were popular during our
...
respondents find it difficult. Another example of high usage paired with high
difficulty.
...
forefront of international layout and it's apparent it's under utilized or
misunderstood.
...
want the ability to use features interoperably with popular libraries and
...
1. API availability / compatibility across browsers.
