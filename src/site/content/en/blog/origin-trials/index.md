...
{% Aside 'warning' %}
  ...
  there is an expected short period of time between the <em>end date of the origin trial</em> and the
  <em>date where the implementation ships in the browser</em> where the API will not be available.
  This is by design.
{% endAside %}
