...
{% Img src="image/admin/yfEKnxDJWT3JY6FWNiOZ.png", alt="DevTools opened and docked to the right hand side of the screen.", width="800", height="475", className="w-screenshot w-screenshot--filled" %}
...
{% Img src="image/admin/ugJI2r5k9y3puAuCX66f.png", alt="DevTools opened to the Lighthouse audits panel.", width="800", height="475", className="w-screenshot w-screenshot--filled" %}
...
{% Img src="image/admin/wy0Zq7fFXXSBeGwK8OgP.png", alt="DevTools showing a Lighthouse audit results report.", width="800", height="475", className="w-screenshot w-screenshot--filled" %}
...
{% Img src="image/admin/3kKMRoc1EY2kHDy8NIHi.png", alt="Lighthouse metrics scores showing green, passing scores, and yellow, warning scores.", width="800", height="504", className="w-screenshot w-screenshot--filled" %}
...
{% Img src="image/admin/hDyQRm4B1K1dRciNTvC1.png", alt="DevTools' filmstrip view of a page loading.", width="800", height="504", className="w-screenshot w-screenshot--filled" %}
...
{% Img src="image/admin/5dHwPPWIho3SckhvsGHt.png", alt="An expanded audit titled Defer offscreen images shows a number of image paths that can be optimized.", width="800", height="652", className="w-screenshot w-screenshot--filled" %}
