...
<figure class="w-figure">
  {% Img src="image/admin/iGwe4M1EgHzKb2Tvt5bl.jpg", alt="COEP issues in the Status column of the Network panel.", width="800", height="444", className="w-screenshot w-screenshot-filled" %}
</figure>

You can then click the entry to see more details.

<figure class="w-figure">
  {% Img src="image/admin/1oTBjS9q8KGHWsWYGq1N.jpg", alt="Details of the COEP issue are shown in the Headers tab after clicking a network resource in the Network panel.", width="800", height="241", className="w-screenshot w-screenshot-filled" %}
</figure>
...
<figure class="w-figure">
  {% Img src="image/admin/8Fh5mUULtCRK5K0738Ss.png", alt="Build your own reporting endpoint by forking a lightweight sample implementation on glitch.com.", width="800", height="496", className="w-screenshot w-screenshot-filled" %}
</figure>
