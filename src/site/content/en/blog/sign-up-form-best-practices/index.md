...
* Put sign-up [in its own &lt;form&gt; element](#single-form).
...
* Use [`autocomplete="current-password"`](#current-password) for a sign-up
  password input.
...
* [Maintain branding and style](#branding) on your sign-up and sign-up pages.
...
help you build a better sign-up experience:
...
two-step verification for sign-up and one-time codes for payment confirmation.
...
basic functional sign-up for older browsers, and can still work even if
JavaScript fails.
...
sign-up and search on the same page, you should use two form elements.
{% endAside %}
...
With an `XMLHttpRequest` or `fetch` request, make sure that sign-up success is
...
Add an `autofocus` attribute to the first input in your sign-up form. That makes
...
<figure class="w-figure">
  <img class="w-screenshot" src="./show-password-google.png" alt="Google sign-up form showing Show password icon." width="300">
  <figcaption class="w-figcaption">Password input from the Google sign-up form: with <strong>Show password</strong> icon and <strong>Forgot password</strong> link.</figcaption>
</figure>
...
<figure class="w-figure">
  <img class="w-screenshot" src="./keyboard-not-ok.png" alt="Two screenshots of a sign-up form on an Android phone: one showing how the Submit button is obscured by the phone keyboard." width="400">
  <figcaption class="w-figcaption">The <b>Sign in</b> button: now you see it, now you don't.</figcaption>
</figure>

Where possible, avoid this by displaying only the email/phone and password inputs and **Sign in** button at the top of your sign-up page. Put other content below.

<figure class="w-figure">
  <img class="w-screenshot" src="./keyboard-ok.png" alt="Screenshot of a sign-up form on an Android phone: the Sign in button is not obscured by the phone keyboard." width="200">
...
<figure class="w-figure">
  <img class="w-screenshot" src="./iphone-keyboard.png" alt="Screenshots of a sign-up form on iPhone 7, 8 and 11. On iPhone 7 and 8 the Sign in button is obscured by the phone keyboard, but not on iPhone 11">
...
<figure class="w-figure">
  <img class="w-screenshot" src="./amazon-signin-mobile.png" alt="Screenshot of a sign-up form on the Amazon website: email/phone and password on two separate 'pages'." width="400">
  <figcaption class="w-figcaption">Two-stage sign-up: email or phone, then password.</figcaption>
</figure>
...
* Use `autocomplete="current-password"` for the password input in a sign-up form, or the
...
<figure class="w-figure">
  <img class="w-screenshot" src="./safari-signin-desktop.png" alt="Screenshots of three stages of sign-up process in Safari on desktop: password manager, biometric authentication, autofill.">
  <figcaption class="w-figcaption">Sign-up with autocomplete—no text entry required!</figcaption>
</figure>

Chrome on desktop displays email suggestions, shows the password manager, and autofills the password.

<figure class="w-figure">
  <img class="w-screenshot" src="./chrome-signin-desktop.png" alt="Screenshots of four stages of sign-up process in Chrome on desktop: email completion, email suggestion, password manager, autofill on selection.">
  <figcaption class="w-figcaption">Autocomplete sign-up flow in Chrome 84.</figcaption>
</figure>
...
a common problem with sign-up forms on many sites.
...
<figure class="w-figure">
  <img class="w-screenshot" src="./invalid-email.png" alt="Screenshot of a sign-up form in Chrome on desktop showing browser prompt and focus for an invalid email value." width="300">
...
<figure class="w-figure">
  <img class="w-screenshot" src="./show-password-google.png" alt="Google sign-up form showing Show password icon." width="350">
  <figcaption class="w-figcaption">Google sign-up form: with <strong>Show password</strong> icon and <strong>Forgot password</strong> link.</figcaption>
</figure>
...
<figure class="w-figure">
  <img class="w-screenshot" src="./show-password.png" alt="Screenshots of sign-up form with Show password text 'button', in Safari on Mac and on iPhone 7." width="800" class="w-screenshot">
  <figcaption class="w-figcaption">Sign-up form with <strong>Show password</strong> text 'button', in Safari on Mac and iPhone 7.</figcaption>
</figure>
...
[Step 5](https://glitch.com/edit/#!/signin-form-codelab-5) of the sign-up form
...
and sign-up forms. You need to set goals, measure success, improve your site—and
repeat.
...
understand how your users experience your sign-up and sign-up forms:

* **Page analytics**: sign-up and sign-up page views, bounce rates,
  and exits.
* **Interaction analytics**: [goal
  funnels](https://support.google.com/analytics/answer/6180923?hl=en) (where do
  users abandon your sign-up or sign-up flow?) and
...
* **Website performance**: [user-centric
  metrics](/user-centric-performance-metrics) (are your sign-up and sign-up
...
different approaches to sign-up and sign-up, and staged rollouts to validate the
changes on a subset of users before releasing changes to all users.

## General guidelines {: #general-guidelines }

Well designed UI and UX can reduce sign-up form abandonment:

* Don't make users hunt for sign-up! Put a link to the sign-up form at the top
...
* Include the logo and name of your company or organization on your signup and
  sign-up pages, and make sure that language, fonts and styles match the rest of
