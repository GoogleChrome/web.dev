...
{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/jjHOGQvZttcOEij3c6UR.svg", alt="Diagram of sending a push message from your server to a push
service", width="800", height="220" %}
...
1. The push service uses the stored public key it received from
   ...
   the private key relating to the public key. _Remember_: The public key is
...
{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/iRDfZt1TmornyUzjT0qW.svg", alt="Illustration of how the private application server key is used when sending a
...
{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/QMpK203iFn9FIWrnFxa3.svg", alt="A illustration of the strings in a JSON Web
Token", width="800", height="246" %}
...
We'll refer to these keys as "local keys". They are used _just_ for encryption and have
_nothing_ to do with application server keys.
...
The 'Encryption' header must contain the _salt_ used for encrypting the payload.
