...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/ztuCT2fpHvBsKxSBJaXn.jpg", alt="Using aria-label to identify an image only button.", width="575", height="268" %}
</figure>
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/YQfKTKuskbWwUg1tLlos.jpg", alt="Using aria-labelledby to identify a radio group.", width="575", height="307" %}
</figure>
...
attributes](https://www.w3.org/TR/wai-aria/states_and_properties#attrs_relationships).
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/K5dAbga6rD8APoZi3IUS.jpg", alt="Using aria-owns to establish a relationship between a menu and a submenu.", width="800", height="377" %}
</figure>
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/v1Ov4bak7cBYT9T6rIGT.jpg", alt="Using aria-activedescendant to establish a relationship in a listbox.", width="800", height="370" %}
</figure>
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/gs2BVykPBYV1Ac2tNr8K.jpg", alt="Using aria-describedby to establish a relationship with a password field.", width="800", height="353" %}
</figure>
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/HL5MFhh74egrOD2537WO.jpg", alt="Using aria-posinset and aria-setsize to establish a relationship in a list.", width="800", height="382" %}
</figure>
