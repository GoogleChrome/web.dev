...
# Guide: Build a great search box
...
This article shows some simple ways to make the search input an invitation, not
a barrier.
...
+   [Responsive search input using JavaScript](https://codepen.io/samdutton/pen/djrVVd)
+   [Responsive search input using a form](https://codepen.io/samdutton/pen/MBxxbm)
+   [Responsive header using Grid and Flex, with branding, search and cart](https://codepen.io/samdutton/pen/ZjZgNP)

> The search field represents the initial step of the user's search
...
approach to how they find products on the site.
— [Baymard Institute](https://baymard.com/blog/search-field-design)

## Make it visible and prominent

People give up quickly, attention spans are short. If users can't find something
immediately, they're likely to give up.

![image](insert_image_url_here)

Amazon and eBay on mobile: search is prominent
...
<thead>
<tr>
<th>For every rule, there's an exception.<br>
A well designed, prominent search input will encourage people to
navigate your site via search.<br>
However, some retailers deliberately downplay the prominence of search
UI to encourage browsing rather than searching.<br>
This is often the case for sites selling clothes. For example, it
seems pretty likely that <a href="http://www.topman.com/">Topman</a>
and <a href="https://www.urbanoutfitters.com/">Urban Outfitters</a>
(see below) know what they're doing: encouraging people to
browse.<br>
<br>
[TODO: Insert Topman and Urban Outfitters screenshots.]<br>
The point is that you should make search prominent unless there's a
good reason not to. De-emphasising search should only be done as a
deliberate choice.</th>
</tr>
</thead>
<tbody>
</tbody>
...
This clarifies the purpose of the input for screenreaders and has the added
advantage of adding an X icon for clearing the text (in Chrome, and Safari on
desktop, with a
[selector for styling](http://nicolasgallagher.com/about-normalize-css/#normalize-css-corrects-common-bugs)):

![image](insert_image_url_here)

If you set input type to ‘search' you get an X icon to clear text on Chrome and
Safari on desktop

#### Add ARIA attributes

[Adding an ARIA label](https://www.w3.org/WAI/tutorials/forms/labels/#using-aria-label)
to your search input helps screenreaders and other assistive technologies:

    <input type="search" aria-label="Search">

Add labels to both the input and search button (if you use one):
...
Often, something that's a complete blocker for a few users is also a pain
point for many others, so by fixing the accessibility issue you improve the
experience for everyone.
—
[developers.google.com/web](https://developers.google.com/web/fundamentals/accessibility/)
...
Unstyled text input: small text, small target
Likewise, allow enough space to enter and display text without overflowing.
Avoid this:

![image](insert_image_url_here)

Poorly styled input: not enough width for search query
Major e-commerce sites virtually always have large search inputs: full width on
mobile, and expanding to fit available width on desktop.

![image](insert_image_url_here)

Amazon and eBay on mobile: full-width search inputs at the top of the page

![image](insert_image_url_here)

eBay on desktop: full-width search input at the top of the page

![image](insert_image_url_here)

Amazon on desktop: full-width search input at the top of the page
[This page](https://baymard.com/ecommerce-search/benchmark/page-types/search-field)
...
[John Lewis](https://www.johnlewis.com/) do this really well. Colors, type
...
There is a complete code sample for this
[here](https://codepen.io/samdutton/full/djrVVd).

### Add an SVG magnifying glass icon

Most e-commerce sites display a magnifying glass icon next to or inside the
search input element. Unless you have a very good reason not to, you should do
...
Many sites force you to click an icon to display the search input. This might
...
This page excerpted from an otherwise excellent site makes you click the
magnifying glass, then enter text. Why not just show the search input?

![image](insert_image_url_here)

Sample desktop e-commerce site: you need to click the magnifying glass to
display the search input
On mobile, this is even more common.

![image](insert_image_url_here)

Sample mobile e-commerce site: you need to tap the magnifying glass to display
the search input
...
… lower-literacy users don't scan text. As a result, for example, they
can't quickly glance at a list of navigation options to select the one they
want.
— [Norman Nielsen](https://www.nngroup.com/articles/writing-for-lower-literacy-users/)
...
shown in the code sample [here](https://codepen.io/samdutton/pen/MBxxbm).
Alternatively, you can use JavaScript as in the code sample
[here](https://codepen.io/samdutton/pen/djrVVd/?editors=1100).
...
provides a JavaScript library for this, and they have a demo
[here](https://community.algolia.com/instantsearch.js/v2/examples/e-commerce/)
that uses IKEA product data.
...
attribute — see the [code demos](https://codepen.io/samdutton/pen/MBxxbm).
...
Automated suggestions can help customers avoid irrelevant results. For example,
a surf shop may sell surfboard wax, but surfboard descriptions may also mention
board and wax, leading to irrelevant results for board wax, as in the example
below.
...
Speech input in keyboard UI for iOS and Android
...
+   [How to add full text search to your website](https://medium.com/dev-channel/how-to-add-full-text-search-to-your-website-4e9c80ce2bf4):
    server and client-side alternatives for implementing search.
...
+   [Responsive search input using JavaScript](https://codepen.io/samdutton/pen/djrVVd)
+   [Responsive search input using a form](https://codepen.io/samdutton/pen/MBxxbm)
+   [Complete header element with branding, search and cart](https://codepen.io/samdutton/pen/ZjZgNP)
