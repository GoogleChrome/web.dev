---
layout: post
title: 'Web Push: Common Issues and Reporting Bugs'
authors:
  - mattgaunt
description: >
...
site's [Application Server Keys (a.k.a. VAPID keys)](https://tools.ietf.org/html/draft-ietf-webpush-vapid-02).
...
helpful, check the [Web Push Protocol spec](https://tools.ietf.org/html/draft-ietf-webpush-protocol) to see if the
...
{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/Z7vysVNK1DdaGCOI7epA.png", alt="Firefox DevTools with decryption message", width="800", height="269" %}

To check if this is the issue in Chrome, do the following:

1. Go to about://gcm-internals and click the "Start Recording" button.

{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/4GCUBppjs7x7cfoRKTNi.png", alt="Chrome GCM internals record", width="800", height="226" %}

1. Trigger a push message, and look under the "Message Decryption Failure Log".

{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/TFFlBV9LY38pp2ON5wFX.png", alt="GCM internals decryption log", width="800", height="155" %}
...
{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/yaSpqIGeGGdUEEj4liFY.png", alt="GCM internals receive message log", width="800", height="117" %}
...
{% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/TowJLArcVFt3zV2PyVj7.png", alt="GCM internals connection state", width="584", height="246" %}
