...
{% Aside %}
If you really want to see JIT in action you should check out
[IRHydra2 by Vyacheslav Egorov](http://mrale.ph/irhydra/2/).
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/iq5yVSd4wRskoD8GywR7.jpg", alt="setTimeout causing the browser to miss a frame.", width="800", height="600" %}
</figure>
...
[Web Workers](https://developer.mozilla.org//docs/Web/API/Web_Workers_API/basic_usage),
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/ExUgS4YIvS4Klx9Ssn1q.png", alt="A performance recording in Chrome DevTools", width="800", height="636" %}
</figure>
