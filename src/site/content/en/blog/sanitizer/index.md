...
Chrome is in the process of implementing the Sanitizer API, and from Chrome 93 you can try out the behavior by enabling `about://flags/#enable-experimental-web-platform-features` flag. In earlier versions of Chrome Canary and Dev channel, you can enable the feature via `--enable-blink-features=SanitizerAPI`. Check out the [instructions for how to run Chrome with flags](https://www.chromium.org/developers/how-tos/run-chromium-with-flags).
