...
<figure>
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/yyBk2geW7lIKqULH5ZIT.png", alt="Illustration of device coordinate frame", width="400", height="250" %}
    <figcaption>
...
#### Alpha
  ...
  <figure>
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/PoeibnLAXFFzDOoPNLzJ.png", alt="Illustration of alpha in the device coordinate frame", width="400", height="250" %}
    <figcaption>
...
<figure>
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/1h9NxeN7yae1Yp4h3xj1.png", alt="illustration of device coordinate frame", width="400", height="250" %}
    <figcaption>
...
#### Gamma
  ...
  <figure>
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/kqDO9oumteoknSlF6lGq.png", alt="illustration of device coordinate frame", width="415", height="388" %}
    <figcaption>
