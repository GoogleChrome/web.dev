...
Below is a [demo](https://web.dev/chrome-ux-report-api/) using the CrUX API to visualize the Core Web Vitals metrics with distributions for **good**, **needs improvement**, and **poor**:
