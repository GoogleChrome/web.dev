...
subhead: Custom elements let you construct your own HTML tags. This checklist covers best practices to help you build high quality elements.
description: |
...
<table class="responsive ce-cl">
  ...
  built-in
  <a href="https://developer.mozilla.org/docs/Web/HTML/Global_attributes/hidden">
