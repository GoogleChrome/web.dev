...
{% Aside 'important' %}
In general, phone numbers are known to be recycled and can be hijacked with social engineering. Yahoo! JAPAN restricts their service to phone carriers operating inside Japan and prohibits VoIP SMS.
{% endAside %}
