...
[`clients.openWindow()`](https://developer.mozilla.org/docs/Web/API/Clients/openWindow)
API.
...
[registration.getNotifications()](https://developer.mozilla.org/docs/Web/API/ServiceWorkerRegistration/getNotifications)
...
true _most_ of the time. The one scenario where you don't have to show a notification is when
...
We use [`clients.matchAll()`](https://developer.mozilla.org/docs/Web/API/Clients/matchAll)
