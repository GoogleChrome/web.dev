...
subhead: |
  Optimizing Core Web Vitals on The Economic Times website significantly improved the user experience while significantly reducing bounce rate across the the entire website.
description: |
  Optimizing Core Web Vitals on The Economic Times website significantly improved the user experience while significantly reducing bounce rate across the the entire website.
authors:
  - anshusharma
...
From routine experiments, We were able to reduce our FID from 200 ms to standing under 50 ms today.
