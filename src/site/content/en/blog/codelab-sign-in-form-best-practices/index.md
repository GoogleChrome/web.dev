...
5.  Focus the email input on a desktop device and type some text. 
    ...
    * `autocomplete="username"` and `autocomplete="current-password"` help browsers use 
    ...
    Different browsers use [different techniques](/sign-in-form-best-practices/#password-   
    managers:~:text=Browser%20password%20and%20autofill%20systems%20are%20not%20simple) 
...
1.  Add a toggle to the password section in the `index.html` file:
    ...
    <section>
      ...
      <button id="toggle-password" type="button" aria-label="Show password as plain text. Warning: this will display your password on the screen.">Show 
        password</button>
