...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/N8tmFmK1H4WQl8u3lBmB.png", alt="iOS chooser.", width="500", height="450" %}
</figure>

<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/ll65O8UAARg1saNbvNzi.png", alt="Android chooser.", width="500", height="450" %}
</figure>
...
1. Get access to the camera stream
1. Attach it to a video element
1. When you want to capture a precise frame, add the data from the video element
