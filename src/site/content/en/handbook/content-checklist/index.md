...
## Basics
1. Is the piece providing value for one or more of the web.dev [personas](/audience)?
...
## Style and voice
1. Is the [voice](/voice) appropriate for the web.dev audience?
...
1. Are common instructions provided using the web.dev [Instruction components](/web-dev-components/#instruction)?
...
1. Is [code highlighting](/markup-code/#code-highlighting) used to indicate lines that have been added or changed?
...
1. Are [dashes and hyphens](/grammar/#dashes-and-hyphens) used correctly?
1. Are titles and headings in sentence case with no terminal period?
1. Are [keyboard key commands](/grammar/#ui-elements-and-interaction) correctly formatted?
