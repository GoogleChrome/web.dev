...
1. Open a new tab and navigate to `labtest.html`.
...
It's particularly important on e-commerce sites to go beyond measuring
...
Now reload the output page, and click around in the funnel. You will see on the
