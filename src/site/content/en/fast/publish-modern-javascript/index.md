...
To specify the browser support target, add a [browserslist configuration](https://github.com/browserslist/browserslist#readme)
...
such as: Optimize Plugin, BabelEsmPlugin, and webpack-plugin-modern-npm.
