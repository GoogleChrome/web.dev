...
smaller than we realize - in many cases increasing from around 95% to 98%.
Unfortunately, this compilation incurs a significant cost:
...
when generating code for bundles and modules. This doesn't transpile your code or dependencies, it only affects the "glue" code generated by webpack. The browser support target can be specified by adding a
[browserslist configuration](https://github.com/browserslist/browserslist#readme)
to your project, or directly in your webpack configuration:
...
environment. This also configures Webpack to load code-splitted bundles using
`<script type="module">`.
