...
This overview explains how web workers and service workers can improve the performance of your web
app, and when to use a web worker versus a service worker. Check out the rest of this series for
...
[workers](https://developer.mozilla.org/en-US/docs/Web/API/Worker) to run scripts in background
...
In this post you'll learn about two different types of workers ([web
workers](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers) and
[service
workers](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API/Using_Service_Workers)),
their similarities and differences, and the most common patterns for using them in production web
apps.
...
and [service
workers](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API/Using_Service_Workers)
are two types of workers available to web apps. They have some things in common:
...
underlying details when building web applications that use Web Workers. It has been used in web apps
...
[Workbox](https://developers.google.com/web/tools/workbox) is a popular library to build web apps
that use service workers. It packages a set of best practices around things like caching, offline,
background synchronization, etc. The [workbox-window
module](https://developers.google.com/web/tools/workbox/modules/workbox-window) provides a
