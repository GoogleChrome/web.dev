...
The disadvantage is that, at the moment of this writing, the API has support from Chrome, Firefox and Edge, but other browsers, like Safari, [don’t support it yet](https://caniuse.com/?search=broadcastchannel).
