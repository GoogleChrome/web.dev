...
- Mueve los costos de *análisis*, lo que significa que la interfaz de usuario podría iniciarse más rápido. Eso podría reducir [First Contentful Paint](/fcp/) (primera pintura de contenido) o incluso [Time to Interactive](/interactive) (tiempo de interacción), lo que a su vez puede aumentar su puntaje [Lighthouse.](https://developers.google.com/web/tools/lighthouse)
