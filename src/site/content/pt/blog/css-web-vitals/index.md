...
A maneira como você escreve seus estilos e cria layouts pode ter um grande impacto no [Core Web Vitals](/collection/). Isso é particularmente verdadeiro para o [Deslocamento cumulativo de layout (CLS)](/cls) e a [Tinta com maior conteúdo (LCP)](/lcp).
