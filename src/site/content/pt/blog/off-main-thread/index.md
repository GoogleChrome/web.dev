...
- Ele move os *custos de análise*, o que significa que a IU pode inicializar mais rápido. Isso pode reduzir o [First Contentful Paint](/fcp/) ou mesmo o [Time to Interactive](/interactive), o que pode, por sua vez, aumentar sua pontuação no [Lighthouse.](https://developers.google.com/web/tools/lighthouse)
