...
{% Banner '注意', '主体' %}事件转化测量 API 将更名为*归因报告 API* 并提供更多功能。
...
{% Banner '信息', '主体' %}**本提案需要您的反馈！**如果您希望发表意见，请在 API 提案的存储库中[创建问题](https://github.com/WICG/conversion-measurement-api/issues/)。{% endBanner %}
...
{% Banner '信息', '主体' %} 如需查看实际效果，请试用[演示版](https://goo.gle/demo-event-level-conversion-measurement-api)⚡️ 并查看相应的[代码](https://github.com/GoogleChromeLabs/trust-safety-demo/tree/main/conversion-measurement)。{% endBanner %}
