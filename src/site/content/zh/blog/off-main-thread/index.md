...
- 它移动*解析*成本，这意味着 UI 可能会启动得更快。这可能会减少 [First Contentful Paint](/fcp/) 甚至 [Time to Interactive](/interactive) ，从而提高您的 [Lighthouse](https://developers.google.com/web/tools/lighthouse) 分数。
