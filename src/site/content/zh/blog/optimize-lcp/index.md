...
<picture>
  <source srcset="{{ " image imgix media="(min-width: 640px)">{% Img src="image/tcFciHGuF3MxnTr1y5ue01OGLBn2/9trpfS9wruEPGekHqBdn.svg", alt="好的 LCP 值为 2.5 秒，差的值大于 4.0 秒，两者之间的任何值都需要改进", width="384", height="96 ", class="w-screenshot w-screenshot--filled width-full" %}</source></picture>
