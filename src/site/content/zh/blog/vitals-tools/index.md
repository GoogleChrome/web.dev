...
下方是使用 CrUX API 来将各项核心 Web 指标可视化的[演示](https://web.dev/chrome-ux-report-api/)，其中的数据分布为**良好**、**需要改进**和**欠佳**：
