...
<figure class="w-figure">{% Img src="image/admin/THLKu0sOPhSghNr0XkP1.png", alt="Chrome 开发者工具中的长任务", width="800", height="132", class="w-screenshot" %}<figcaption class="w-figcaption"> Chrome 开发者工具在性能面板中<a href="https://developers.google.com/web/updates/2020/03/devtools#long-tasks">将长任务可视化</a></figcaption></figure>
