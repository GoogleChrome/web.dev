...
<figure class="w-figure">{% Img src="image/admin/THLKu0sOPhSghNr0XkP1.png", alt="Chrome DevTools での長く時間がかかっているタスク", width="800", height="132", class="w-screenshot" %} <figcaption class="w-figcaption">Chrome DevTools のパフォーマンス パネルで<a href="https://developers.google.com/web/updates/2020/03/devtools#long-tasks">可視化された、長く時間がかかっているタスク</a></figcaption></figure>
