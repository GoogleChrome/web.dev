...
<h3 data-md-type="header" data-md-header-level="3">High-quality user experience</h3>
...
<p data-md-type="paragraph">To identify a "poor" threshold for LCP, we use CrUX data to identify a threshold met by most origins:</p>
