...
- **CLS(Cumulative Layout Shift: 누적 레이아웃 이동)**
    ...
    놀랍도록 많은 캐러셀에서 CLS의 원인이 될 수 있는 낮은 품질의 비합성 애니메이션을 사용합니다. 자동 재생 캐러셀이 있는 페이지에서 이는 무한 CLS를 유발할 가능성이 있습니다. 이러한 유형의 CLS는 일반적으로 사람의 눈으로는 분명히 보이지 않아 문제를 간과하기 쉽습니다. 이 문제를 방지하려면 캐러셀에서 [비합성 애니메이션의 사용을 피하십시오](/non-composited-animations/).(예: 슬라이드 전환 중)
