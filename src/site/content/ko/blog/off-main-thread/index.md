...
- *구문 분석* 비용이 전가되므로 UI 부팅이 더 빨라집니다. 그러면 [First Contentful Paint](/fcp/) 또는 [Time to Interactive](/interactive)가 줄어 역으로 [Lighthouse](https://developers.google.com/web/tools/lighthouse) 점수가 증가할 수 있습니다.
