...
<picture>
  <source srcset="{{ " image imgix media="(min-width: 640px)">{% Img src = "image / tcFciHGuF3MxnTr1y5ue01OGLBn2 / Se4TiXIdp8jtLJVScWed.svg", alt = "Хорошие значения fid - 2,5 секунды, низкие значения больше 4,0 секунд, и все, что находится между ними, требует улучшения", width = "384", height = "96 ", class =" w-screenshot w-screenshot - заполнено по всей ширине "%}</source></picture>
...
<figure class="w-figure">{% Img src = "image / admin / THLKu0sOPhSghNr0XkP1.png", alt = "Длительные задачи в Chrome DevTools", width = "800", height = "132", class = "w-screenshot"%}<figcaption class="w-figcaption"> Chrome DevTools <a href="https://developers.google.com/web/updates/2020/03/devtools#long-tasks">визуализирует длительные задачи</a> на панели производительности</figcaption></figure>
