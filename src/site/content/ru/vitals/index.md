...
Самый простой способ измерить все показатели Core Web Vitals — использовать [JavaScript-библиотеку web-Vitals](https://github.com/GoogleChrome/web-vitals), которая представляет собой небольшую, готовую к работе оболочку для базовых веб-API, и измеряет каждую метрику аналогично инструментам Google, перечисленным выше.
...
Поставщики аналитики — как с интегрированной поддержкой показателей Core Web Vitals, так и без нее — должны включать базовые функции пользовательских метрик, позволяющие измерять Core Web Vitals в их инструментах.
