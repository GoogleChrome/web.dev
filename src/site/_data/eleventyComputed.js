...
// TODO(samthor): This should really be anywhere but "eleventy --watch". We only use "--watch" in
// "npm run dev", so we could get yet another env var?
...
const resourcesVersion = isProd ? hashFor(...dependentResources) : '';
