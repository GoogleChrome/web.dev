...
const {BuildOther} = require('./deps/content.js');
const devsiteDeps = require('./deps/devsite-deps.js');
 ...
 * @return {!Array<string>}
 */
async function DevsiteRelativeInclude(cf) {
  ...
  const devsiteConfig = devsiteDeps(cf.path, read);
  return devsiteConfig.includes;
}
