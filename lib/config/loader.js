...
module.exports = (callback) => {
  ...
  // Generate any leftover Markdown files that haven't been caught yet.
  loader.register('./*.md', generators.MarkdownBuilder);

  // generate guides JSON inside HTML: brand new file from guides YAML
  loader.register('_allguides.html', generators.AllGuidesJSONInHTML);
