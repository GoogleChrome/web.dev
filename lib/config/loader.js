...
module.exports = (callback) => {
  ...
  // Build author-provided content pages
  // from their corresponding Markdown files.
  // The regex below means that this matches Markdown files
  // that are under at least one subfolder.
  ...
  // The HTML file for a path is only built if we find a matching YAML file,
  // e.g. `foo.html` needs `foo/guides.yaml`.
  ...
  // Generate top-level HTML files. _-prefixed files are hidden on DevSite,
  // and can only be used as includes for others.
