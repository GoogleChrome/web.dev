...
module.exports = (callback) => {
  ...
  // nb. Some team members can't deploy _-prefixed files. These don't show up as real HTML files
  // anyway (no <html> etc), so won't be deployed by DevSite.
  loader.register('root-cards.html', generators.RootCardsHTML);
