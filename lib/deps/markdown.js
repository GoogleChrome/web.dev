...
// nb. mirror Marked's replacement code, as its `escape` method is not expoed to users.
...
class Renderer extends marked.Renderer {
  code(code, lang, escaped) {
    ...
    // DevSite doesn't expect a `<code>` block, it just looks for `<pre class="prettyprint">`.
...
module.exports = (raw) => {
  if (raw == null) {  // check for null/undefined
    return '';
  }
