...
/**
 * @typedef {Object} FileResults - The results (passes/failures/warnings)
 * generated by linting a file.
 * @property {!string} file - The path to the file that was linted.
 * @property {Array<RuleResult>} passes - Collection of all the rules with
 * passing status.
 * @property {Array<RuleResult>} failures - Collection of all the rules with
 * failing status.
 * @property {Array<RuleResult>} warnings - Collection of all the rules with
 * warning status.
 */
