 ...
 */
const modulePath = '../../../../../../.github/actions/lint-front-matter/linters/all-files';
let allFiles;
let githubStub;
...
describe('all-files', function() {
  beforeEach(function() {
    githubStub = {};
    allFiles = proxyquire(modulePath, {'@actions/github': githubStub});
  });

  it('should return nothing if no files match', async function() {
    const files = [];
    const actual = await allFiles(files);
